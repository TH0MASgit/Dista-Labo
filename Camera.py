...
class Opencv_cam:
    ...
    def __init__(self, args, linuxid, vflip, hflip):
        ...
        self.cap.set(cv2.CAP_PROP_BRIGHTNESS, args.bright)
...
class Stereocam:
    ...
    def __init__(self, args, camleft, camright, serial_number, cam_id):
        ...
        self.buggycloudcenter=False

        self.distmat = []
        self.detecs = []
        self.object_center_positions = []
        self.wristL_3d_position = []
        self.wristR_3d_position = []
        ...
        self.coef=self.disparityProcessor.calibration
        self.calib=self.disparityProcessor.rectifiedLeft
        self.displim = self.disparityProcessor.num_disp
        self.dispdwon = self.disparityProcessor.disparityDownScale
    ...
    def read(self):
        ...
        if self.camright != None or not args.zed:
    ...
    def get_rectified_left_right(self):
        ...
        if self.camright != None:
            left_frame = self.camleft.read()
            right_frame = self.camright.read()
            self.netimage_data = np.copy(left_frame)
    ...
    def net_get_rectified_left(self):
        ...
        if self.camright != None:
            ...
            frame = self.camleft.read()
            self.netimage_data =np.copy(frame)
        ...
        if args.nerian:
            netleft_frame_rect = left_frame

        elif args.ipcam:
            netleft_frame_rect = frame
            ...
            netleft_frame_rect  =  self.disparityProcessor.netrectifyLeft(left_frame)
    ...
    def net_rectified_left(self):
        rect_netimage_data  =  self.disparityProcessor.netrectifyLeft(self.netimage_data)
        return rect_netimage_data
