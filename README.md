<html lang="fr-ca">
	...
	<body>
        ...
        <p>5.1 Cette modification a pour but de régler une erreur dans l'application de calibration concernant l'effacement des fichiers durant l'étape de calibration stéréoscopique. En essayant de supprimer l'une des images, on obtenait l'erreur "AttributeError : 'tuple' object has non attribute "getFileName" ", ce qui nous forçait à supprimer manuellement les fichiers dans leur dossier. C'est en modifiant le code "CalibratorApplication" en ajustant la fonction "handleOnDeleteFile" et la fonction "getImage" dans le code "CalibratorStereoProcessor" que le problème fut réglé.</p>
        <p>5.2 La liste des Jetson Nano modifiés sont : Nano-25, Nano-11, Nano-37, Nano-34, Nano-32, Nano-39, Nano-26, Nano-22, Nano-17, Nano-38, Nano-27, Nano-19, Nano-01, Nano-31, Nano-30, Nano-33, Nano-29, Nano-8, Nano-13 et Nano-12. Il manquerait seulement de mettre à jour la Nano-18. C'est en renommant le vieux fichier "dista" avec un autre nom et en téléchargeant le code de GitHub avec la commande "git clone https://github.com/College-Andre-Laurendeau/Dista-Labo.git Documents/dista" dans le terminal de la Jetson Nano qu'on peut résoudre le problème relié à la suppression des fichiers dans l'étape de calibration stéréoscopique.</p>
	</body>	
