<html lang="fr-ca">
	...
	<body>
		...
		<p><div style="font-size:large"><B>Figure 3 — Panneau de configuration de l’application de calibration</B></div></p>
		...
		<p><div style="font-size:large"><B>Figure 4 — Damier correctement détecté</B></div></p>
		...
		<p><div style="font-size:large"><B>Figure 5 — Image prise avec succès</B></div></p>
		...
		<p><div style="font-size:large"><B>Figure 6 — L’erreur de reprojection est affichée en bas à gauche de l’écran</B></div></p>
		...
		<p><div style="font-size:large"><B>Figure 7 — Exemples de captures d’images</B></div></p>
		...
		<p><div style="font-size:large"><B>Figure 8 — Exemples de captures d’images en stéréo</B></div></p>
		...
		<p><div style="font-size:large"><B>Figure 9 — Outil de visualisation de la carte de profondeur</B></div></p>
		<ul>
		...
		<p><div style="font-size:large"><B>Figure 11 — Affichage de la distance</B></div></p>
		...
		<p><div style="font-size:large"><B>Figure 12 — Distance entre objets</B></div></p>
